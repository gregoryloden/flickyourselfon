...
"%ffmpeg%" -i "flick switch.m4a" -filter_complex "[0:a]volume=1,atrim=start=3.64:end=3.84[a1];[0:a]volume=1,atrim=start=5.51:end=5.71[a2];[0:a]volume=1,atrim=start=7.31:end=7.51[a3];[a1][a2][a3]amix=inputs=3,asetrate=55563[outa]" -map "[outa]" "..\switch on.wav" -y
