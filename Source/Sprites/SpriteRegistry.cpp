...
SpriteSheet* SpriteRegistry::endGameBootWaves = nullptr;
...
SpriteAnimation* SpriteRegistry::endGameRadioWavesAnimation = nullptr;
...
SpriteAnimation* SpriteRegistry::endGameBootWavesAnimation = nullptr;
...
void SpriteRegistry::loadAll() {
	...
	endGameBootWaves = newSpriteSheetWithImagePath("endgamewaves.png", 4, 1, true);
	playerWalkingAnimation = newSpriteAnimation(
		player,
		{
			...
			newSpriteAnimationFrame(0, SpriteAnimation::absentSpriteIndex, playerWalkingAnimationTicksPerFrame) COMMA
			newSpriteAnimationFrame(2, SpriteAnimation::absentSpriteIndex, playerWalkingAnimationTicksPerFrame) COMMA
		});
	playerLegLiftAnimation = newSpriteAnimation(
		player,
		{
			newSpriteAnimationFrame(3, SpriteAnimation::absentSpriteIndex, playerKickingAnimationTicksPerFrame) COMMA
		});
	playerBootWalkingAnimation = newSpriteAnimation(
		player,
		{
			...
			newSpriteAnimationFrame(4, SpriteAnimation::absentSpriteIndex, playerWalkingAnimationTicksPerFrame) COMMA
			newSpriteAnimationFrame(6, SpriteAnimation::absentSpriteIndex, playerWalkingAnimationTicksPerFrame) COMMA
		});
	...
	playerFastBootWalkingAnimation = newSpriteAnimation(
		player,
		{
			...
			newSpriteAnimationFrame(4, SpriteAnimation::absentSpriteIndex, playerFastWalkingAnimationTicksPerFrame) COMMA
			newSpriteAnimationFrame(6, SpriteAnimation::absentSpriteIndex, playerFastWalkingAnimationTicksPerFrame + 1) COMMA
		});
	...
	endGameRadioWavesAnimation = newSpriteAnimation(
		radioWaves,
		{
			newSpriteAnimationFrame(0, 0, radioWaveAnimationTicksPerFrame) COMMA
			newSpriteAnimationFrame(1, 0, radioWaveAnimationTicksPerFrame) COMMA
	...
	endGameRadioWavesAnimation->disableLooping();
	...
	endGameBootWavesAnimation = newSpriteAnimation(
		endGameBootWaves,
		{
			newSpriteAnimationFrame(0, 0, endGameBootWaveAnimationTicksPerFrame) COMMA
			newSpriteAnimationFrame(1, 0, endGameBootWaveAnimationTicksPerFrame) COMMA
			newSpriteAnimationFrame(2, 0, endGameBootWaveAnimationTicksPerFrame) COMMA
			newSpriteAnimationFrame(3, 0, endGameBootWaveAnimationTicksPerFrame) COMMA
		});
	endGameBootWavesAnimation->disableLooping();
